...
export const metadata: Metadata = {
  title: 'Experiences',
  description:
    'Six things to do from Hotel Ambalakely. Ranomafana lemurs, rice field walks, cooking with Hasina, Sahambavy tea, Andringitra trek, the school visit.',
  alternates: { canonical: '/experiences' },
  openGraph: {
    title: 'Experiences · Hotel Ambalakely',
    description: 'Six things to do, all arranged from the desk.',
    url: '/experiences',
    images: [
      {
          ...
          <div className="mx-auto max-w-[700px] px-5 md:px-8">
            <ScrollReveal>
              <p className="font-display font-light text-[var(--color-text)] text-[28px] md:text-[40px] leading-[1.2] tracking-[-0.025em] balance">
                Six things you can do from the hotel. All arranged from the desk.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.05}>
              <p className="mt-12 prose-editorial">
                ...
                Sahambavy and Andringitra need a driver. We arrange the driver,
                the park guide, the picnic and the tea, in any combination.
              </p>
            </ScrollReveal>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                ...
                <div className="lg:col-span-9 max-w-[760px]">
                  ...
                  <ScrollReveal delay={0.1}>
                    <p className="mt-8 font-display font-light italic text-[var(--color-text-muted)] text-[18px] md:text-[22px] leading-[1.4]">
                      {exp.tagline}
                    </p>
                  </ScrollReveal>
                  <ScrollReveal delay={0.15}>
                    <p className="mt-10 prose-editorial">{exp.body}</p>
                  </ScrollReveal>
                </div>
              </div>
            </div>
