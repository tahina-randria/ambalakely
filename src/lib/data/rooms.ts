...
export const reviews = [
  ...
  {
    quote:
      'Unique countryside location, ten minutes from central Fianarantsoa. Wide views over the rice fields. Food and lodging were exceptional. Try Hasina\u2019s homemade ice cream.',
